  ...
  return (
    <div className="w-[600px]">
      <Collapsible open={isOpen} onOpenChange={onOpenChange}>
        <CollapsibleTrigger
          className="squircle-lg bg-elevated-surface border-border-default hover:bg-surface-secondary flex w-full items-center justify-between border px-4 py-3 transition-colors"
          disabled={disabled}
        >
        ...
        <CollapsibleContent className="mt-3">
          <div className="squircle-lg bg-surface-secondary space-y-4 p-4">
            {/* Reference Field */}
            <div className="space-y-2">
              ...
              <input
                ...
                disabled={disabled}
                className="squircle-lg bg-elevated-surface border-border-default text-regular-sm text-text-primary w-full border px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
              />
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                disabled={disabled}
                className="border-border-default h-4 w-4 rounded text-blue-500 focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
              />
              <label
            ...
            {clearExisting && (
              <div className="squircle-lg border border-rose-500/20 bg-rose-500/10 p-3">
