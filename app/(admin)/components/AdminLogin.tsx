...
const AdminLogin: React.FC = () => {
  ...
  const onSubmit = async (data: AdminLoginFormValues) => {
    ...
    try {
      ...
      // Fetch user profile to get county and role
        ...
        <div className="space-y-6">
          ...
          <div className="hidden md:block space-y-4 text-left">
            <p className="text-[12.5px] leading-relaxed text-neutral-600 dark:text-neutral-300">
              Digital administration platform for cadastral mapping, valuation rolls, and rates reconciliation across Kenya&apos;s county governments.
            </p>
            ...
            <div className="space-y-1.5 pt-1">
              <div className="border-b border-neutral-200/50 bg-neutral-50/50 px-3 py-2.5 dark:border-neutral-800/60 dark:bg-neutral-800/20">
                <p className="text-xs font-semibold text-neutral-900 dark:text-neutral-100">47 County Registries</p>
                <p className="mt-0.5 text-[11px] text-neutral-500 dark:text-neutral-400">
                  Cadastral boundaries, GIS parcel layers, and official valuation rolls
                </p>
              </div>

              <div className="border-b border-neutral-200/50 bg-neutral-50/50 px-3 py-2.5 dark:border-neutral-800/60 dark:bg-neutral-800/20">
                <p className="text-xs font-semibold text-neutral-900 dark:text-neutral-100">Direct Reconciliation</p>
                <p className="mt-0.5 text-[11px] text-neutral-500 dark:text-neutral-400">
                  Automated verification against live M-Pesa paybills and bank transaction feeds
                </p>
              </div>

              <div className="border-b border-neutral-200/50 bg-neutral-50/50 px-3 py-2.5 dark:border-neutral-800/60 dark:bg-neutral-800/20">
                <p className="text-xs font-semibold text-neutral-900 dark:text-neutral-100">Clearance Certificates</p>
                <p className="mt-0.5 text-[11px] text-neutral-500 dark:text-neutral-400">
                  Instant compliance clearance on settled accounts
                </p>
              </div>
            </div>
          </div>
