  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'squircle-lg bg-popover text-popover-foreground relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto border shadow-lg',
          'data-[state=open]:animate-[spring-in_0.4s_cubic-bezier(0.34,1.56,0.64,1)]',
          'data-[state=closed]:animate-[spring-out_0.3s_cubic-bezier(0.32,0,0.67,0)]',
          position === 'popper' &&
